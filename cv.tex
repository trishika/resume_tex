...
\section{\textsc{\T{Experience}{Expérience}}}
	...
	\subsection{\textsc{\T{Jobs}{Emplois}}}
		...
		{\T{Software engineer, working on android platform for cars}
		{Ingénieur de développement pour des systèmes multimedia sur android}}
		{Parrot}{Paris}{}{}

		\LongText{
			\cvline{}{
				\T{Development of the android platform use on multiple OEM product}
				{Développement de la platform android utilisé par plusieur produits OEM}
			}
		}
		...
		\LongText{
			\cvline{}{
				...
				\emph{\T{Technical environment}{Environnement technique}}
				\begin{myitemize}
					\item Java, C/C++ ;
					\item Android ;
				\end{myitemize}
		...
		{\T{Consulting software engineer, image processing and Linux embedded systems}
		{Ingénieur de développement, traitement d'image et systèmes embarqués Linux}}
		{OpenWide}{Paris}{}{}
	...
	\subsection{\textsc{\T{Internships}{Stages}}}
		...
		{\T{Internship in an image processing laboratory}{Stage en laboratoire de traitement d'image}}
	...
	\subsection{\textsc{\T{Personnal Projects}{Projets personnels}}}
		...
		\cvline{DroidUPnP}
		{\T{\textbf{Android application} allowing control of UPnP compatible device and share of local multimedia content.}
		{\textbf{Application Android} permettant de controller les appareils compatibles UPnP ainsi que de partager du contenus multimedia.}}

	\LongText{
		\cvline{Home-Pi}
		{\T{\textbf{A Home domotique service on top of raspberrypi.}
		By controlling a temperature sensor (through I2C) and a radio emmiter (through GPIO),
...
\section{\textsc{\T{IT Skills}{Compétences}}}
	...
	\cvline{\T{Version control}{Gestion de version}}{Git}
