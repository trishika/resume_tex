...
\section{\textsc{\T{Experience}{Expérience}}}
	...
	\subsection{\textsc{\T{Jobs}{Emplois}}}
		...
		\cventry{\T{Dec 2014 - now}{Depuis Dec 2014}}
		...
		\cvline{}{
			\T{Server software development to serve video content (live and VOD)
			in all existing OTT protocols (DASH, HLS...).}
			{Développement pour serveur fournissant du contenu vidéo avec les protocoles OTT (DASH, HLS...)}
		}

		\LongText{
			\cvline{}{
				\T{Worked on the migration to PostgreSQL (from SQLite) by writing
				database management tools in python up to the web user interface
				in PHP. Main focus of work was around database request optimization
		...
		\LongText{
			\cvline{}{
				...
				Architecture and development of the communication stack between on site
		...
		% Oct 2011 - Aug 2012
		\cventry{\T{Oct 2011 - Aug 2012 }{Oct 2011 - Aout 2012 }}
		{\T{Software engineer, Image processing and Linux system development}
		{Ingénieur de développement, Traitement d'image et développement linux}}
		{OpenWide}{Paris}{}{}

		\cvline{}{
			\T{Worked on a software that help maintaining the reliability of big CCTV
			installation by doing daily check on recording.}
	...
	\subsection{\textsc{\T{Personnal Projects}{Projets personnels}}}
		...
		\cvline{DroidUPnP}
		{\T{\textbf{Android application} allowing control of UPnP compatible
		device and share of local multimedia content.}
		{\textbf{Application Android} permettant de controller les appareils
		compatibles UPnP ainsi que de partager du contenus multimedia.}}
