...
\LongText{
    ...
    Highly experienced software developer in C++, Java and Python. I have a strong knowledge of the Linux environment and experience in working for embedded system as well as optimised server software. I love developing knowledge in a wide range of new technologies and I have basic knowledge in different other programming languages such as Go, Rust and Ruby. I am an experienced Scrum developer.
}
...
\section{\textsc{\T{Skills}{Compétences}}}

	\cvline{\T{Programmings}{Programmation}}{C++, C, Java, Python, Ruby, Go, Rust, Bash, Javascript, PHP, SQL, HTML, CSS}
	\cvline{Libraries/\T{Tools}{Outils}}{Git, Android, QT, OpenCV, Buildroot, Boost, Gstreamer, Kafka}
    \cvline{\T{Platforms}{Environnement}}{GNU/Linux, Busybox/Linux, Android}

\section{\textsc{\T{Experience}{Expérience}}}

	%\subsection{\textsc{\T{Jobs}{Emplois}}}

		\cventry{\T{Sept 2016 --\linebreak Sept 2017}{Sept 2016 --\linebreak Sept 2017}}
		...
		{Corvil}{Dublin}{}{
				...
				Features of those plugins include latency tracking, order tracking as well as malware and threat detection.}
		...
		\LongText{
			\cvline{}{
				...
				C++, Boost, Java, Kafka, Linux
			}
		}

		\cventry{\T{Dec 2014 --\linebreak Sept 2016}{Dec 2014 --\linebreak Sept 2016}}
		{\T{Software engineer, infotainment system for cars}
		...
		{Parrot Automotive}{Paris}{}{
				...
				graphical views and behaviours of the media, telephony and system applications.
				Conception of Android and Linux based system with the business development team.}
		...
		% Jun 2014 - Nov 2014
		\cventry{\T{Jun 2014 --\linebreak Nov 2014}{Juin 2014 --\linebreak Nov 2014}}
		{\T{Software engineer, OTT video streaming (contractor for OpenWide)}
		...
		\LongText{
			\cvline{}{
				...
				in PHP. Worked also on database request optimisation
		...
		% Nov 2013 - May 2014
		\cventry{\T{Nov 2013 --\linebreak May 2014}{Nov 2013 --\linebreak Mai 2014}}
		...
		{OpenWide}{Paris}{}{
			\T{Project to optimise the park time of automatic subway with video
			analysis and real time communication with the subway command centre.}
		...
		\LongText{
			\cvline{}{
				\small
				\T{Image processing optimisation and adaptation of existing algorithms.
				Architecture and development of the communication stack between the on site
				server and the centralised one, as well as with the command centre.
		...
		% Sept 2012 - Oct 2013
		\cventry{\T{Sept 2012 --\linebreak Oct 2013}{Sept 2012 --\linebreak Oct 2013}}
		...
		% Oct 2011 - Aug 2012
		\cventry{\T{Sept 2011 --\linebreak Aug 2012}{Sept 2011 --\linebreak Août 2012}}
		{\T{Software engineer, Image processing and Linux system development}
	...
	\subsection{\textsc{\T{Internships}{Stages}}}
		...
		\cventry{\T{Mar --\linebreak  Aug}{Mars --\linebreak  Août} 2011}
		...
		{\T{Development of a tools to apply an interpolation algorithms
		on a satellite database with Matlab.}
	...
	\LongText{
	\subsection{\textsc{\T{Personal Projects}{Projets personnels}}}
		...
		\cvline{Home-Pi}
		{\T{\textbf{A Home domotic service on top of raspberrypi.}
		By controlling multiple temperature sensors (DHT11 + ESP8266) and a radio emitter (through GPIO),
		home heaters and lights are monitored, controlled and scheduled from a phone
		or a computer.}
		{\textbf{Service domotic pour raspberrypi.}
...
\section{\textsc{\T{Studies}{Formation}}}
	...
	\cventry{2008 -- 2011}
	{\T{Master of Engineering in Computer Science}
	{Diplômé ingénieur en informatique}}
	{INP ENSEEIHT \T{(top ranking engineering school)}{(École d'ingénieur)}}
	{Toulouse\T{ ( France )}{}}{}
	{
		\T{Specialised in Computer Science and Applied Mathematics}
	...
	\cventry{Sept --\linebreak  \T{Dec}{Déc} 2010}
	{\T{Master of Engineering in Computer Science}{Master en informatique}}
...
\section{\textsc{\T{Languages}{Langues}}}
	...
	\cvlanguage{\T{English}{Anglais}}{\T{Full professional proficiency}{Niveau professionnel}}{}
